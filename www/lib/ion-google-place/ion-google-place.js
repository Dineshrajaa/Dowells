                ...
                link: function(scope, element, attrs, ngModel) {
                    ...
                    popupPromise.then(function(el) {
                        ...
                        scope.selectLocation = function(location) {
                            var place = location;
                            if (!angular.isUndefined(scope.nu)) {
                                scope.nu.streetaddress = scope.nu.city = scope.nu.state = scope.nu.postcode = "";
                                var componentForm = {
                            ...
                            }else if(!angular.isUndefined(scope.uu)){
                                scope.uu.streetaddress = scope.uu.city = scope.uu.state = scope.uu.postcode = "";
                                var componentForm = {
                                    street_number: 'long_name',
                                    route: 'long_name',
                                    locality: 'long_name',
